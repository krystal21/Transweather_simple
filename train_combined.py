"""
Transweather训练脚本 - 多尺度融合 + 数据增强版本
结合MultiScale模型和Mosaic/Mixup数据增强进行训练
"""
import os
import time
import argparse
...
def main():
    # 解析参数
    parser = argparse.ArgumentParser(description='Transweather训练脚本 - 多尺度融合 + 数据增强版本')
